...
local modes = {
  ['copy_mode'] = { display = 'COPY', },
  ['normal_mode'] = { display = 'NORMAL', },
  ['search_mode'] = { display = 'SEARCH', },
}

function get_current_mode(window)
...
local section_ab_separator = {
  { Foreground = { Color = colors.a.bg } },
  { Background = { Color = colors.b.bg } },
  { Text = config.sections.separators.left }
}

local section_bc_separator = {
  { Foreground = { Color = colors.b.bg } },
  { Background = { Color = colors.c.bg } },
  { Text = config.sections.separators.left }
}

local section_xy_separator = {
  { Foreground = { Color = colors.c.bg } },
  { Background = { Color = colors.b.bg } },
  { Text = config.sections.separators.right }
}

local section_yz_separator = {
  { Foreground = { Color = colors.b.bg } },
...
local function create_attributes(window)
  ...
  local colors = config.themecurrent_mode
  attributes_a = {
...
local function create_sections(window)
  local config = config.sections
  tabline_a = insert_component_separators(util.extract_components(config.tabline_a, attributes_a, window, true), true)
  tabline_b = insert_component_separators(util.extract_components(config.tabline_b, attributes_b, window, true), true)
  tabline_c = insert_component_separators(util.extract_components(config.tabline_c, attributes_c, window, true), true)
  tabline_x =
      insert_component_separators(util.extract_components(config.tabline_x, attributes_x, window, true), false)
  tabline_y =
      insert_component_separators(util.extract_components(config.tabline_y, attributes_y, window, true), false)
  tabline_z =
      insert_component_separators(util.extract_components(config.tabline_z, attributes_z, window, true), false)
end
