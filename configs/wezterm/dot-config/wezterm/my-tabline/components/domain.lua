...
return {
  for_window = function(window, pane, extra) return make(pane:get_domain_name()) end,
  for_tab = function(tab_info, extra) return make(tab_info.active_pane.domain_name) end
}
